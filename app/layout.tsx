...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${syne.variable}`}>
      ...
      <body>
        {/* Always open pages at the top: stop the browser from restoring a
            previous scroll position on reload/reopen, but keep #anchor links. */}
        <Script id="scroll-top-on-load" strategy="beforeInteractive">
          {`if ('scrollRestoration' in history) { history.scrollRestoration = 'manual'; }
            document.addEventListener('DOMContentLoaded', function () {
              // Keep #anchor links and the /schedule?service= deep-scroll working.
              if (!window.location.hash && !window.location.search.includes('service=')) {
                window.scrollTo(0, 0);
              }
            });`}
        </Script>
        ...
        <div className="nav-mobile">
          <div className="nav-mobile-links">
            <a href="/"><span className="nav-mobile-index">01</span>Home</a>
            <a href="/about"><span className="nav-mobile-index">02</span>About Us</a>
            <a href="/services"><span className="nav-mobile-index">03</span>Services</a>
            <a href="/pricing"><span className="nav-mobile-index">04</span>Pricing</a>
            <a href="/blog"><span className="nav-mobile-index">05</span>Blog</a>
            <a href="/contact"><span className="nav-mobile-index">06</span>Contact</a>
          </div>
          ...
          <div className="nav-mobile-footer">
            ...
            <div className="nav-mobile-contact">
              <a href="tel:+19412635325" className="nav-mobile-phone">(941) 263-5325</a>
              <a href="mailto:hello@allthingsautomated.com">hello@allthingsautomated.com</a>
              <span>Sarasota, FL · Mon–Fri 9am–5pm</span>
            </div>
        ...
        <div className="mobile-action-bar">
          <a href="tel:+19412635325" className="mobile-action mobile-action-call">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
            </svg>
            <span>Call</span>
          </a>
          <a href="/schedule" className="mobile-action mobile-action-book">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
